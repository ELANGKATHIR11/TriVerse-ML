...
def resolve_dataset_path(default_path_str: str) -> Path:
...
HEART_PATH = resolve_dataset_path("F:/3ml project/datasets/disease_prediction_heart.csv")
DIABETES_PATH = resolve_dataset_path("F:/3ml project/datasets/disease_prediction_diabetes.csv")
BREAST_PATH = resolve_dataset_path("F:/3ml project/datasets/disease_prediction_breast_cancer.csv")
