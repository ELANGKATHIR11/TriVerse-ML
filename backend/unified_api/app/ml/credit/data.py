...
DATASET_PATH = resolve_dataset_path("F:/3ml project/datasets/credit_scoring_give_me_some_credit.csv")
GERMAN_PATH = resolve_dataset_path("F:/3ml project/datasets/credit_scoring_german.csv")
