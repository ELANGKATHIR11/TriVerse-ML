    ...
    async def train(
        ...
        with mlflow.start_run(run_name=f"cnn_e{epochs}_b{batch_size}") as run:
            ...
            try:
                ...
                self.model.save("trained_models/vision/cnn.h5")
                logger.info("CNN model saved to trained_models/vision/cnn.h5")
            except Exception as save_exc:
                logger.warning("Failed to save CNN model: %s", save_exc)
